...
VideoItem.prototype.toJXML = function(node, attributes, request, callback) {
  ...
  Res.prototype.toJXML.call(this, node, attributes, request, function(error,
    ...
    if (attributes.hasSubtitle === "SRT") {
      ...
      if (node.service.secDlnaEnabled) {
        content.push({
        ...
        Item.addNamespaceURI(xml, "sec", ContentDirectoryService.SEC_DLNA_XMLNS);
      }
