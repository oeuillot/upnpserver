...
Res.prototype.toJXML = function(node, attributes, request, attributesFilter,
    callback) {

  var self = this;

  return Item.prototype.toJXML
      .call(
          this,
          node,
          attributes,
          ...
          function(error, xml) {
            ...
            if (attributesFilter(Xmlns.UPNP_METADATA, "albumArtURI")) {
            ...
            if (attributesFilter(Xmlns.DIDL_LITE, "res")) {
