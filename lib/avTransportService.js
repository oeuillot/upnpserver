...
var  AVTransportService = function(device, classPrefix, configuration) {
  ...
  this.addType("LastChange", "string", "", [], {"xmlns:avt-event":"urn:schemas-upnp-org:metadata-1-0/AVT/"}, true, 0.2);
...
AVTransportService.prototype.play = function(){
  ...
  var uri  = this.soapArgs["AVTransportURI"];
  var meta = this.soapArgs["AVTransportURIMetaData"];
  var track= 1;
...
AVTransportService.prototype.processSoap_SetNextAVTransportURI = function(xml, request, callback) {
    ...
    var media = this.soapArgs["NextURI"];
    var meta  = this.soapArgs["NextURIMetaData"];
