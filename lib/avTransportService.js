...
AVTransportService.prototype.processSoapRequest = function(fn, xml, soapAction, request, response, callback){

  var scope = this.getInstance(xml);
  Service.prototype.processSoapRequest.apply(scope, arguments);
