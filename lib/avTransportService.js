...
AVTransportService.prototype.buildPlayListInfo	= function(type, state, format){
  ...
  var Jxml = {
	...
	self.stateVars["A_ARG_TYPE_PlaylistInfo"].set(PlaylistInfo);	// BEWARE !! xml does the escape job on strings
...
AVTransportService.prototype.processSoap_SetNextAVTransportURI = function(xml, request,
    ...
    if (!media || !meta) {
      callback(402, "SetNextAVTransportURI without media / meta");
      return
    }
...
AVTransportService.prototype.processSoap_SetAVTransportURI = function(xml, request,
    ...
    if (!media || !meta) {
      callback(402, "SetAVTransportURI without media / meta");
      return
    }
