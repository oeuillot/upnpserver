...
AVTransportService.prototype.processSoap_Seek = function(xml, request,
    response, callback) {
  var self = this;
  var target = self.childValue(xml, "Target", Xmlns.UPNP_SERVICE);
  var unit   = self.childValue(xml, "Unit", Xmlns.UPNP_SERVICE);
...
AVTransportService.prototype.processSoap_SetNextAVTransportURI = function(xml, request,
    response, callback) {
    var self = this;
    var media = self.childValue(xml, "NextURI", Xmlns.UPNP_SERVICE);
    var meta  = self.childValue(xml, "NextURIMetaData", Xmlns.UPNP_SERVICE);
...
AVTransportService.prototype.processSoap_SetAVTransportURI = function(xml, request,
    ...
    var self = this;
    var media = self.childValue(xml, "CurrentURI", Xmlns.UPNP_SERVICE);
    var meta  = self.childValue(xml, "CurrentURIMetaData", Xmlns.UPNP_SERVICE);
