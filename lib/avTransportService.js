...
var  AVTransportService = function(device, classPrefix, configuration) {
  ...
  this.addType("LastChange", "string", "", [], {"avt-event":"urn:schemas-upnp-org:metadata-1-0/AVT/"}, true, 0.2);
...
AVTransportService.prototype.processSoap_Seek = function(request, callback) {
  var self = this;
  var target = this.stateVars["A_ARG_TYPE_SeekTarget"].get();
  var unit   = this.stateVars["A_ARG_TYPE_SeekMode"].get();
...
AVTransportService.prototype.processSoap_Play = function(request, callback) {
      var self = this;
...
AVTransportService.prototype.processSoap_Stop = function(request, callback) {
      var self = this;
...
AVTransportService.prototype.processSoap_Pause = function(request, callback) {
      var self = this;
...
AVTransportService.prototype.processSoap_Next = function(request, callback) {
      var self = this;
...
AVTransportService.prototype.processSoap_Previous = function(request, callback) {
      var self = this;
...
AVTransportService.prototype.processSoap_SetNextAVTransportURI = function(request, callback) {
    var self = this;
    var media = this.stateVars["NextAVTransportURI"].get();
    var meta  = this.stateVars["NextAVTransportURIMetaData"].get();
 ...
 *
 */
AVTransportService.prototype.processSoap_SetAVTransportURI = function(request, callback) {

    var self = this;
    var media = this.stateVars["AVTransportURI"].get();
    var meta  = this.stateVars["AVTransportURIMetaData"].get();
