...
MusicRepository.prototype._construct = function(rootItem, path, tags, callback) {
  ...
  tags.album = (typeof (tags.album) === "string")
      ? tags.album.trim() : null;
  tags.title = (typeof (tags.title) === "string")
      ? tags.title.trim() : null;
  tags.artist = (typeof (tags.artist) === "string")
      ? tags.artist.trim() : null;
  tags.genre = (typeof (tags.album) === "string")
      ? tags.genre.trim() : null;
