...
MusicRepository.prototype.processFile = function(rootItem, infos, callback) {
  ...
  var stream = fs.createReadStream(infos.path);
      ...
      .getChildByName(
          ...
          function(error, item) {
            ...
            if (item) {
              ...
              return self.registerTitle(rootItem, path, title, tags,
                  tryCount + 1, callback);
            }
            ...
            var configuration = self.contentDirectoryService.upnpServer.configuration.dlnaSupport;
            ...
            return self.newMusicTrack(rootItem, path, null, attributes,
                callback);
          });
};
