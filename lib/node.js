    ...
    this._take("children", () => {
      ...
      if (childrenIds !== undefined) {
        ...
        Async.mapLimit(childrenIds, LIST_CHILDREN_LIMIT, (id, callback) => {
          ...
          if (debugListChildren.enabled) {
            debugListChildren("Node.listChildren #", this._id, "=> map returns", result);
          }
      ...
      if (debugListChildren.enabled) {
        debugListChildren("Node.listChildren #", this._id, "=> not in cache !");
      }
      ...
      service.browseNode(this, (error, list) => {
        ...
        if (debugListChildren.enabled) {
          debugListChildren("Node.listChildren #", this._id, "=>", list);
        }
