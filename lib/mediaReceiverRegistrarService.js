...
var MediaReceiverRegistrar = function(device, classPrefix, configuration) {
  ...
  this.addType("A_ARG_TYPE_DeviceID", "string",600);
  this.addType("A_ARG_TYPE_RegistrationReqMsg", "bin.base64",600);
  this.addType("A_ARG_TYPE_RegistrationRespMsg", "bin.base64",600);
  this.addType("A_ARG_TYPE_Result", "int",600, 1);
  this.addType("AuthorizationDeniedUpdateID", "ui4",600, 1, [], {
    "xmlns:dt" : Xmlns.MICROSOFT_DATATYPES,
    "dt:dt" : "int"
  }, true);
  this.addType("AuthorizationGrantedUpdateID", "ui4",600, 1, [], {
    "xmlns:dt" : Xmlns.MICROSOFT_DATATYPES,
    "dt:dt" : "int"
  }, true);
  this.addType("ValidationRevokedUpdateID", "ui4",600, 1, [], {
    "xmlns:dt" : Xmlns.MICROSOFT_DATATYPES,
    "dt:dt" : "int"
  }, true);
  this.addType("ValidationSucceededUpdateID", "ui4",600, 1, [], {
    "xmlns:dt" : Xmlns.MICROSOFT_DATATYPES,
    "dt:dt" : "int"
  }, true);
...
MediaReceiverRegistrar.prototype.processSoap_IsAuthorized = function(xml,
  ...
  var deviceID = this.soapVars["DeviceID"];
  this.soapVars["Result"] = 1;
