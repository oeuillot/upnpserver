...
//  console.log("ContentHandlers=",ar);
    ...
    Async.eachSeries(ar, (contentHandler, callback) => {
      ...
      contentHandler.prepareMetasFromContentURL(infos.contentURL, metas, (error) => {
        if (error) {
          logger.error("Continue processing",error);
        }
