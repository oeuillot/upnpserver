...
ContentDirectoryService.prototype.processSoap_Search = function(xml, request,
  ...
  return this.responseSearch(response, request, objectId, attributesFilter,
          ...
          function(error, item) {
            ...
            function processList(list, node) {
              ...
              if (repositoryRequest.dlnaSupport) {
                xmlDidl._attrs["xmlns:dlna"] = Xmlns.DLNA_METADATA;
              }
                  ...
                  .eachSeries(
                      ...
                      function(child, callback) {
                        ...
                        self.getNodeJXML(child, null, repositoryRequest,
                            attributesFilter, function(error, itemJXML) {
                              if (error) {
                                return callback(error);
                              }
...
ContentDirectoryService.prototype.processBrowseMetadata = function(response,
    request, objectId, attributesFilter, callback) {
  ...
  this
      .getNodeById(
          ...
          function(error, node) {
            ...
            self.getNodeJXML(node, null, repositoryRequest, attributesFilter,
...
ContentDirectoryService.prototype.getNodeJXML = function(node,
    inheritedAttributes, repositoryRequest, attributesFilter, callback) {
  ...
  if (refID) {
    node.resolveLink(function(error, refNode) {
      ...
      self.getNodeJXML(refNode, linkAttributes, repositoryRequest,
          attributesFilter, function(error, refNodeJXML) {
            if (error) {
              return callback(error);
            }
  ...
  this.prepareNodeAttributes(node, ContentDirectoryService.SYNC_PRIORITY,
      function(error, node) {
        ...
        itemClass.toJXML(node, attributes, repositoryRequest, attributesFilter,
            function(error, itemJXML) {
              ...
              self.emitToJXML(node, attributes, repositoryRequest,
                  attributesFilter, itemJXML, function(error) {
...
ContentDirectoryService.prototype.emitToJXML = function(node, attributes,
    request, attributesFilter, xml, callback) {
  ...
  this.asyncEmit(eventName, node, attributes, request, attributesFilter, xml,
      function(error) {
        if (error === false) {
          return callback();
        }

        self.asyncEmit(eventName2, node, attributes, request, attributesFilter,
            xml, function(error) {
              if (error !== false) {
                return callback(error);
              }
