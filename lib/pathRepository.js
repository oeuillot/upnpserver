...
var PathRepository = function (mountPath, path, searchClasses) {
	...
	logger.info('hello from path repository');
...
PathRepository.prototype.browse = function (list, item, callback) {
	...
	var self = this,
		...
		path = itemPath.substring(this.mountPath.length);
	...
	fs.readdir(path, function (error, files) {
		...
		logger.debug("PathRepository: path " + path + " returns " + files.length + " files");
