...
const debug = require('debug')('upnpserver:repository:Virtual');
...
class VirtualRepository extends Repository {
   ...
   * 
   */
  newFile(parentNode, path, upnpClass, stats, attributes, before, callback) {
    ...
    super.newFile(parentNode, path, upnpClass, stats, attributes, before, callback);
  }
