...
var debug = require('debug')('device:musicRepository');
...
var MusicRepository = function(configuration) {
  ...
  ScannerRepository.call(this, configuration);
...
MusicRepository.prototype.processFile = function(rootItem, contentURL, infos, callback) {
  ...
  this.service.createNode(name, MusicTrack.UPNP_CLASS,
...
MusicRepository.prototype.registerArtistsFolder = function(parentItem,
  ...
  var artitsLabel = this.service.device.configuration.i18n.ARTISTS_FOLDER;
  ...
  parentItem.getChildByName(album, function(error, albumItem) {
    ...
    if (albumItem) {
      ...
      if (itemData.albumArtists) {
        if (!albumItem.attributes.artists) {
          albumItem.attributes.artists = itemData.albumArtists;

        } else {
          var aa = albumItem.attributes.artists;
    ...
    self.newVirtualContainer(parentItem, itemData.album, MusicAlbum.UPNP_CLASS,
        null, function(error, albumItem) {
          ...
          if (itemData.albumArtists) {
            albumItem.artists = itemData.albumArtists;
          }
...
MusicRepository.prototype.registerAlbumsFolder = function(parentItem, itemData,
  ...
  var albumsLabel = this.service.device.configuration.i18n.ALBUMS_FOLDER;
