...
class MusicRepository extends ScannerRepository {
  ...
  processFile(rootNode, infos, callback) {
    ...
    this.contentDirectoryService.createNode(name, MusicTrack.UPNP_CLASS,
      ...
      node.getAttributes(ContentDirectoryService.MED_PRIORITY, (error, attributes) => {
        ...
        this.registerAlbumsFolder(rootNode, itemData, (error, musicTrackItem) => {
          if (error) {
            return callback(error);
          }
  ...
  registerMusicTrack0(parentNode, itemData,
    ...
    parentNode.getChildByTitle(
        t,
        (error, musicTrackNode) => {
          if (error) {
            return callback(error);
          }
          ...
          if (itemData.musicTrackItem) {
            ...
            return this.newNodeRef(parentNode, itemData.musicTrackItem, null,
                callback);
          }
