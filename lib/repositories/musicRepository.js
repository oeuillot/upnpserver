...
class MusicRepository extends ScannerRepository {
  ...
  registerArtistsFolder0(parentNode, itemData, artistName, callback) {
    ...
    parentNode.getFirstChildByName(artitsLabel, (error, artistsNode) => {
  ...
  registerArtist0(parentNode, itemData,
    ...
    parentNode.getFirstChildByName(artistName, (error, artistNode) => {
      if (error) {
        return callback(error);
      }
  ...
  registerAlbum0(parentNode, itemData,
    ...
    parentNode.getFirstChildByName(album, (error, albumNode) => {
      if (error) {
        return callback(error);
      }
  ...
  registerMusicTrack0(parentNode, itemData, callback) {
    ...
    parentNode.listChildrenByTitle(t, (error, musicTrackNodes, musicTrackLinks) => {
      ...
      debug("Find musicTrack=", t, "in #", parentNode.id, "=>", musicTrackNodes.length);
      ...
      for(var i=0;i<musicTrackNodes.length;i++) {
        var mu=musicTrackNodes[i];
        ...
        debug("Not the same modification time for musicTrack, parent #", parentNode.id, " title=",
            t, "node #", mu.id);
  ...
  registerGenre0(parentNode, itemData,
    ...
    parentNode.getFirstChildByName(genreName, (error, genreItem) => {
      if (error) {
        return callback(error);
      }
  ...
  registerAlbumsFolder0(parentNode,
    ...
    parentNode.getFirstChildByName(albumsLabel, (error, albumsNode) => {
