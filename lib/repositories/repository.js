/*jslint node: true, plusplus:true, node: true */
"use strict";
...
Repository.prototype.initialize = function(service, callback) {
  ...
  var self = this;
  service.allocateNodesForPath(this.mountPath, function(error, node) {
    if (error) {
...
Repository.prototype.newFile = function(parentNode, contentURL, upnpClass,
  ...
  function processStats(stats) {
    ...
    if (!upnpClass) {
      ...
      var upnpClasses = self.contentDirectoryService.searchUpnpClass(fileInfos);
      if (upnpClasses && upnpClasses.length) {
        upnpClass = self.acceptUpnpClass(upnpClasses, fileInfos);
      }
    }
...
Repository.prototype.acceptUpnpClass = function(upnpClasses, fileInfos) {
  if (!upnpClasses) {
    return null;
  }
...
Repository.prototype.newVirtualContainer = function(parentNode, name,
  ...
  this.contentDirectoryService.newNode(parentNode, name, upnpClass, attributes,
      before, function(error, newNode, newNodeId) {
