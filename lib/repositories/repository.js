...
//  attributes.contentURL = contentURL;
    ...
    var processStats = (stats) => {
      ...
      this.contentDirectoryService.newNode(parentNode, name, upnpClass,
  ...
  newVirtualContainer(parentNode, name, upnpClass, attributes, before, callback) {
    ...
    this.contentDirectoryService.newNode(parentNode, name, upnpClass, attributes, true, (node) => {
      node.virtual=true;
  ...
  newNodeRef(parentNode, targetNode, name, initCallback, before, callback) {
    ...
    this.contentDirectoryService.newNodeRef(parentNode, targetNode, name, initCallback, before,
        callback);
  }
}
