...
var Service = function(properties, configuration) {
  ...
  this.eventNameSpace = properties.eventNameSpace;
...
Service.prototype.processSoapRequest = function(fn, xml, request, response, callback){
  var self = this;
...
Service.prototype.processControlRequest = function(request, response, callback) {
  ...
  request.on('end', function() {
    ...
    self.processSoapRequest.call(self, fn, xml, request, response, callback);
