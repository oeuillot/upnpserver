    ...
    if (a._content.name === soapAction) {
      ...
      for (j = 0; j < args.length; j++) {
          ...
          if (arg.direction === "in"){
            ...
            var valid = this.stateVars[arg.relatedStateVariable].validate(value);

            if (value === ""){
              this.soapVars[arg.name] = null;
            } else {
              this.soapVars[arg.name] =
                this.stateVars[arg.relatedStateVariable].validate(value);
            }
          }
      }
      break;
