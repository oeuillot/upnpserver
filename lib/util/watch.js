  ...
  return {
    ...
    each: function() {
      var temp = Object.keys(cache).filter(function(name){
        // either is or has been file/dir
    ...
    setTimeout(function() {
      ...
      fileNameCache
        .each(function(f) {
          ...
          // check if file/dir was here before this event
          var exist = fileNameCache.exist(f)
          ,   change= memo.has(f)
          ,   event = exist && change ? "change" : exist ? "remove" : "add";
          ;

          cb.call(null, f, event);
