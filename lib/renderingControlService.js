...
RenderingControlService.prototype.responseSoap_Actions = function(action, response, callback){
  var self = this;
  this.responseSoap(
          response,
          action,
...
RenderingControlService.prototype.processSoap_SetVolume = function(xml, request,
    response, callback){
      ...
      this.emit("volume", volume, function(){
          this.responseSoap_Actions("SetVolume", response, callback);
      }.bind(this));
...
RenderingControlService.prototype.processSoap_SetMute = function(xml, request,
    response, callback){
      ...
      this.emit("mute", mute, function(){
          this.responseSoap_Actions("SetMute", response, callback);
      }.bind(this));
